...
# On crée deux prints pour tester qu'ils sont éxécuter dans le fichier "main.py" --> ils sont bien lancés, ce qui pause problème.
    print(verification_adn("toto"))
    print(verification_adn("atcg"))
